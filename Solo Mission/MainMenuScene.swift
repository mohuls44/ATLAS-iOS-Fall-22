...
//  Alien Splash
//
//  Created by Mohul Srivastava on 11/10/22.
//
...
class MainMenuScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // Set up labels.
        gameBy = makeLabel(text: "Mohul Srivastava", fontSize: 50,fontColor: SKColor.white,
        position: CGPoint(x: self.size.width*0.5, y: self.size.height*0.78))
        self.addChild(gameBy)
        
        gameName1 = makeLabel(text: "Alien", fontSize: 200,fontColor: SKColor.white,
        position: CGPoint(x: self.size.width*0.5, y: self.size.height*0.7))
        self.addChild(gameName1)
        
        gameName2 = makeLabel(text: "Splash", fontSize: 200,fontColor: SKColor.white,
